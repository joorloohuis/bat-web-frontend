...
// @var $upload \common\models\Upload
...
$dataProvider = new ActiveDataProvider([
    ...
    'query' => Yii::$app->user->can('admin') ? Firmware::findByUpload($upload) : Firmware::findByUserAndUpload(Yii::$app->user->identity->username, $upload),
    'pagination' => [
        'pageSize' => 20,
    ],
]);
